...
function Grid(gridID, numRows, numCols) {
  ...
  this.$active = this.$id.find("td.activecell");
...
Grid.prototype.handleKeyDown = function(e, $id) {
  ...
  switch (e.keyCode) {
    case this.keys.tab: {
         ...
         this.$active.removeClass("activecell");
    ...
    case this.keys.left: {
      ...
      if (this.$active.index() > 0) {
        ...
        this.$active.attr("tabindex", "-1");
        this.$active.attr("aria-selected","false");
        this.$active = this.$active.prev();
        this.$active.attr("tabindex", "0");
        this.$active.addClass("activecell");
